...
public class CustomAnalogClock_English extends View {
...
//    private int state=0;
    ...
    public CustomAnalogClock_English(Context context){
        super(context);
        Log.d("로그", "CustomAnalogClock(Context context) 호출");
    }

    public CustomAnalogClock_English(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        btn_next_analogClock=findViewById(R.id.btn_next_analogClock);
    ...
    public CustomAnalogClock_English(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(timeSpentInMinute==70&&second==0) {
            setExamEnd(true);
        }
