...
public class CustomAnalogClock_Korean extends View {
...
//    private int state=0;
    ...
    public CustomAnalogClock_Korean(Context context){
        super(context);
        Log.d("로그", "CustomAnalogClock(Context context) 호출");
    }

    public CustomAnalogClock_Korean(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        btn_next_analogClock=findViewById(R.id.btn_next_analogClock);
    ...
    public CustomAnalogClock_Korean(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(timeSpentInMinute==80&&second==0) {
            setExamEnd(true);
        }
