...
public class CustomAnalogClock_math extends View {
    ...
    private int start_hour=10;
    private int start_minute=30;
...
//    private int state=0;
    ...
    public CustomAnalogClock_math(Context context){
        super(context);
        Log.d("로그", "CustomAnalogClock(Context context) 호출");
    }

    public CustomAnalogClock_math(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        btn_next_analogClock=findViewById(R.id.btn_next_analogClock);
    ...
    public CustomAnalogClock_math(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(timeSpentInMinute==100&&second==0) {
            setExamEnd(true);
        }
