...
public class CustomAnalogClock_science extends View {
...
//    private int state=0;
    ...
    public CustomAnalogClock_science(Context context){
        super(context);
        Log.d("로그", "CustomAnalogClock(Context context) 호출");
    }

    public CustomAnalogClock_science(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        btn_next_analogClock=findViewById(R.id.btn_next_analogClock);
    ...
    public CustomAnalogClock_science(Context context, AttributeSet attrs, int defStyleAttr) {
