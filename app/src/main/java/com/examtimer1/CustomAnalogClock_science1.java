...
public class CustomAnalogClock_science1 extends View {
    ...
    private int start_hour=3;
    private int start_minute=35;
...
//    private int state=0;
    ...
    public CustomAnalogClock_science1(Context context){
        super(context);
    }

    public CustomAnalogClock_science1(Context context, AttributeSet attrs) {
        super(context, attrs);
//        btn_start_analogClock=findViewById(R.id.btn_start_analogClock);
//        btn_next_analogClock=findViewById(R.id.btn_next_analogClock);
    }

    public CustomAnalogClock_science1(Context context, AttributeSet attrs, int defStyleAttr) {
