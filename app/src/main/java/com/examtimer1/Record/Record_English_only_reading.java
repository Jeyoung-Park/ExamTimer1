...
public class Record_English_only_reading extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_record_english_only_reading);
        ...
        recyclerView = findViewById(R.id.rv_record_English_only_reading);
        recyclerView.setHasFixedSize(true);

        timerRecordItems.clear();
//        recyclerviewAdater.notifyDataSetChanged();
        mDBHelper = new DBHelper(Record_English_only_reading.this, "TABLE_SUBJECT_ENGLISH_ONLY_READING");
...
//            db.setTransactionSuccessful();
        ...
        recyclerviewAdater = new MyAdapter(timerRecordItems, Record_English_only_reading.this, "TABLE_SUBJECT_ENGLISH_ONLY_READING");
