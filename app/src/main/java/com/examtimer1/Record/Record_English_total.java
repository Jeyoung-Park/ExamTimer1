...
public class Record_English_total extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_record_english_total);
        ...
        recyclerView = findViewById(R.id.rv_record_English_total);
        recyclerView.setHasFixedSize(true);

        timerRecordItems.clear();
        mDBHelper = new DBHelper(Record_English_total.this, "TABLE_SUBJECT_ENGLISH_TOTAL");
        ...
        recyclerviewAdater = new MyAdapter(timerRecordItems, Record_English_total.this, "TABLE_SUBJECT_ENGLISH_TOTAL");
