...
public class Record_foreignLanguage extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_record_foreignlanguage);
        ...
        recyclerView = findViewById(R.id.rv_record_foreign_language);
        recyclerView.setHasFixedSize(true);

        timerRecordItems.clear();
        mDBHelper = new DBHelper(Record_foreignLanguage.this, "TABLE_SUBJECT_FL");
