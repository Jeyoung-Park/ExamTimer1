...
public class Record_math extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_record_math);
        ...
        recyclerView = findViewById(R.id.rv_record_math);
        ...
        recyclerviewAdater = new MyAdapter(timerRecordItems, Record_math.this, "TABLE_SUBJECT_MATH");
