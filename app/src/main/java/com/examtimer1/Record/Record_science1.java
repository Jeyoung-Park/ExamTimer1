...
public class Record_science1 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_record_science1);
        ...
        recyclerView = findViewById(R.id.rv_record_science1);
        recyclerView.setHasFixedSize(true);

        timerRecordItems.clear();
        mDBHelper = new DBHelper(Record_science1.this, "TABLE_SUBJECT_SCIENCE1");
        ...
        recyclerviewAdater = new MyAdapter(timerRecordItems, Record_science1.this, "TABLE_SUBJECT_SCIENCE1");
