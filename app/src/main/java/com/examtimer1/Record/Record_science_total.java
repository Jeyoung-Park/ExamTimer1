...
public class Record_science_total extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_record_science_total);
        ...
        recyclerView = findViewById(R.id.rv_record_science_total);
        recyclerView.setHasFixedSize(true);

        timerRecordItems.clear();
        mDBHelper = new DBHelper(Record_science_total.this, "TABLE_SUBJECT_SCIENCE_TOTAL");
        ...
        recyclerviewAdater = new MyAdapter(timerRecordItems, Record_science_total.this, "TABLE_SUBJECT_SCIENCE_TOTAL");
