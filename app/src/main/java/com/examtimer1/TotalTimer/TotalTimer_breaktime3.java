...
public class TotalTimer_breaktime3 extends AppCompatActivity {
    private static final long START_TIME_IN_MILLIS=20*60*1000;

    private TextView TextView_time_breaktime3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tt_breaktime3);
        ...
        TextView_time_breaktime3=findViewById(R.id.TextView_time_breaktime3);
        btn_start_pause=findViewById(R.id.btn_start_pause_breaktime3);
        btn_stop_save=findViewById(R.id.btn_stop_save_breaktime3);
        btn_reset=findViewById(R.id.btn_reset_breaktime3);
        btn_next_Korean=findViewById(R.id.btn_next_breaktime3);
        ...
        btn_next_Korean.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TotalTimer_breaktime3.this, TotalTimer_history.class);
...
//                btn_next_Korean.setVisibility(View.VISIBLE);
                Toast toast=Toast.makeText(TotalTimer_breaktime3.this, "쉬는 시간이 종료되었습니다.\n 화살표 버튼을 눌러 다음 시험에 응시하세요", Toast.LENGTH_SHORT);                toast.show();
            }
        }.start();
        isTimerRunning=true;
    }
    ...
    private void updateCountDownText(){
        ...
        TextView_time_breaktime3.setText(timeLeftFormatted);
    }
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("나가기", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
                Intent tempIntent=new Intent(TotalTimer_breaktime3.this, MainActivity.class);
