...
public class TotalTimer_breaktime_after_history extends AppCompatActivity {
    private static final long START_TIME_IN_MILLIS=10*60*1000;

    private TextView TextView_time_breaktime_after_history;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tt_breaktime_after_history);
        ...
        TextView_time_breaktime_after_history=findViewById(R.id.TextView_time_breaktime_after_history);
        btn_start_pause=findViewById(R.id.btn_start_pause_breaktime_after_history);
        btn_stop_save=findViewById(R.id.btn_stop_save_breaktime_after_history);
        btn_reset=findViewById(R.id.btn_reset_breaktime_after_history);
        btn_next_Korean=findViewById(R.id.btn_next_breaktime_after_history);
        ...
        btn_next_Korean.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TotalTimer_breaktime_after_history.this, TotalTimer_science1.class);
    ...
    private void startTimer(){
        mCountDownTimer=new CountDownTimer(timeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                btn_start_pause.setText("시작");
                Toast toast=Toast.makeText(TotalTimer_breaktime_after_history.this, "쉬는 시간이 종료되었습니다.\n 화살표 버튼을 눌러 다음 시험에 응시하세요", Toast.LENGTH_SHORT);                toast.show();
            }
        }.start();
        isTimerRunning=true;
    }
    ...
    private void updateCountDownText(){
        ...
        TextView_time_breaktime_after_history.setText(timeLeftFormatted);
    }
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("나가기", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
                Intent tempIntent=new Intent(TotalTimer_breaktime_after_history.this, MainActivity.class);
