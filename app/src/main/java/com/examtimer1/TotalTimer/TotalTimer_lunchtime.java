...
public class TotalTimer_lunchtime extends AppCompatActivity {
    private static final long START_TIME_IN_MILLIS=50*60*1000;

    private TextView TextView_time_lunchtime;
    private Button btn_start_pause, btn_reset, btn_stop_save;
    private ImageButton btn_next_lunch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_stop_save=findViewById(R.id.btn_stop_save_lunchtime);
        btn_reset=findViewById(R.id.btn_reset_lunchtime);
        btn_next_lunch=findViewById(R.id.btn_next_lunchtime);
        ...
        btn_next_lunch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TotalTimer_lunchtime.this, TotalTimer_English.class);
...
//                btn_next_Korean.setVisibility(View.VISIBLE);
                Toast toast=Toast.makeText(TotalTimer_lunchtime.this, "점심 시간이 종료되었습니다.\n 화살표 버튼을 눌러 다음 시험에 응시하세요", Toast.LENGTH_SHORT);                toast.show();
            }
        }.start();
        isTimerRunning=true;
    }
    ...
    private void updateCountDownText(){
        ...
        TextView_time_lunchtime.setText(timeLeftFormatted);
    }
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("나가기", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
                TotalTimer_lunchtime.super.onBackPressed();//뒤로가기
            }
        });
