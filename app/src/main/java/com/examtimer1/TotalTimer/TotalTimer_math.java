...
public class TotalTimer_math extends AppCompatActivity {
    private static final long START_TIME_IN_MILLIS=100*60*1000;

    private TextView TextView_time_math_tt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_tt);

        this.getSupportActionBar().hide(); // 상단 바 숨기기
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON); //화면 꺼짐 방지


        TextView_time_math_tt=findViewById(R.id.TextView_time_math_tt);
        btn_start_pause=findViewById(R.id.btn_start_pause_tt_math);
        btn_stop_save=findViewById(R.id.btn_stop_save_tt_math);
        btn_reset=findViewById(R.id.btn_reset_tt_math);
        btn_next_Korean=findViewById(R.id.btn_next_math);
        ...
        btn_next_Korean.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TotalTimer_math.this, TotalTimer_lunchtime.class);
                ...
                intent.putExtra("time_math", spentTime);
    ...
    private void startTimer(){
        mCountDownTimer=new CountDownTimer(timeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                btn_start_pause.setText("시작");
                btn_next_Korean.setVisibility(View.VISIBLE);
                Toast toast=Toast.makeText(TotalTimer_math.this, "시험이 종료되었습니다.\n화살표 버튼을 눌러 다음 과목으로 이동하세요", Toast.LENGTH_SHORT);
                toast.show();
            }
        }.start();
        isTimerRunning=true;
    ...
    private void updateCountDownText(){
        ...
        TextView_time_math_tt.setText(timeLeftFormatted);
    }
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("나가기", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
                Intent tempIntent=new Intent(TotalTimer_math.this, MainActivity.class);
