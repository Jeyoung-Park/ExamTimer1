...
public class TotalTimer_science1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science1_tt);

        this.getSupportActionBar().hide(); // 상단 바 숨기기

        TextView_time_history_tt=findViewById(R.id.TextView_time_science1_tt);
        btn_start_pause=findViewById(R.id.btn_start_pause_tt_science1);
        btn_stop_save=findViewById(R.id.btn_stop_save_tt_science1);
        btn_reset=findViewById(R.id.btn_reset_tt_science1);
        btn_next_Korean=findViewById(R.id.btn_next_science1);
        ...
        btn_next_Korean.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TotalTimer_science1.this, TotalTimer_breaktime_after_science1.class);
                ...
                intent.putExtra("time_science1", spentTime);
    ...
    private void startTimer(){
        mCountDownTimer=new CountDownTimer(timeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                btn_start_pause.setText("시작");
                btn_next_Korean.setVisibility(View.VISIBLE);
                Toast toast=Toast.makeText(TotalTimer_science1.this, "시험이 종료되었습니다.\n화살표 버튼을 눌러 다음 과목으로 이동하세요", Toast.LENGTH_SHORT);
                toast.show();
            }
        }.start();
        isTimerRunning=true;
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("나가기", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
                Intent tempIntent=new Intent(TotalTimer_science1.this, MainActivity.class);
